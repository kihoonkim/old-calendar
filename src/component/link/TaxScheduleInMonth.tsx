  ...
  return (
    <div className={styles.container}>
      <div className={styles['public-link']}>
        ...
        <a href={'https://www.kebhana.com/cont/mall/mall15/mall1501/index.jsp'} target="_blank" rel="noopener noreferrer">오늘의 환율</a>
      </div>

      <div className={styles['private-link']}>
        <a href={'https://forms.gle/3rGTVbdyQvEbMXDr8'} target="_blank" rel="noopener noreferrer">피드백</a>
        <a href={'https://forms.gle/3rGTVbdyQvEbMXDr8'} target="_blank" rel="noopener noreferrer">깃허브</a>
